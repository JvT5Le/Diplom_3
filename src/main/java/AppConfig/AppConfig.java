...
public class AppConfig {
    public static final String YANDEX_BIN_PATH = "C:\\Users\\yshinkovich\\AppData\\Local\\Yandex\\YandexBrowser\\Application\\browser.exe";
    ...
    public static final String EMAIL = "yoyo223@io.io";
    public static final String PASSWORD = "12134567890pass";
    public static final String NAME = "Yuriy Yo";
    public static final String EXPECTED_SIGN_IN_TEXT = "Оформить заказ";
    public static final String EXPECTED_SUCCESSFUL_TEXT = "Войти";
    public static final String EXPECTED_INVALID_PASS_TEXT = "Некорректный пароль";
